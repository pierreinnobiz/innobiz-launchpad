...
const FAQSection: React.FC = () => {
  ...
  const faqs = [
    ...
    { q: t3(language, "Quel est le MOQ pour une commande stock ?", 'What is the MOQ for a stock order?', '¿Cuál es el MOQ para un pedido de stock?'), a: t3(language, "Minimum 500 unités, livrées en Tolia brandé. Expédition depuis notre entrepôt français sous 72 heures si les produits sont en stock. Parfait pour tester le marché ou compléter une gamme existante sans délais longs.", 'Minimum 500 units, delivered as branded Tolia. Ships from our French warehouse within 72 hours if products are in stock. Perfect for testing the market or complementing an existing range without long lead times.', 'Mínimo 500 unidades, entregadas como Tolia con marca. Envío desde nuestro almacén francés en 72 horas si los productos están en stock. Perfecto para probar el mercado o complementar una gama existente sin plazos largos.') },
    ...
    { q: t3(language, "Ma marque peut-elle utiliser ses propres huiles essentielles avec Tolia ?", 'Can my brand use its own essential oils with Tolia?', '¿Mi marca puede usar sus propios aceites esenciales con Tolia?'), a: t3(language, "Oui, c'est le principe fondamental de Tolia. Grâce à la technologie Twist & Mist, le diffuseur est compatible avec tous les flacons d'huiles essentielles ou de parfums au format DIN 18 (de 5 à 50 ml). Vos clients utilisent directement vos propres flacons : il suffit de visser le flacon sur le module de nébulisation. Aucun transfert, aucun remplissage, aucun intermédiaire.", "Yes, that is the fundamental principle of Tolia. Thanks to Twist & Mist technology, the diffuser is compatible with all essential oil or perfume bottles in DIN 18 format (5 to 50 ml). Your customers use your own bottles directly: simply screw the bottle onto the nebulisation module. No transfer, no filling, no intermediary.", 'Sí, ese es el principio fundamental de Tolia. Gracias a la tecnología Twist & Mist, el difusor es compatible con todos los frascos de aceites esenciales o perfumes en formato DIN 18 (de 5 a 50 ml). Sus clientes usan sus propios frascos directamente: basta con enroscar el frasco en el módulo de nebulización. Sin transferencia, sin llenado, sin intermediarios.') },
    ...
    { q: t3(language, "Quel prix de vente prévoir ?", 'What retail price should we plan for?', '¿Qué precio de venta deberíamos planificar?'), a: t3(language, "Le positionnement retail et la structure de prix dépendent du marché, du canal et du niveau de packaging. Les prix B2B et la structure de marge sont partagés lors de votre première conversation qualifiée avec notre équipe.", 'Retail positioning and pricing structure depend on market, channel, and packaging tier. B2B pricing and margin details are shared during your first qualified conversation with our team.', 'El posicionamiento retail y la estructura de precios dependen del mercado, canal y nivel de packaging. Los precios B2B y los detalles de margen se comparten durante su primera conversación cualificada con nuestro equipo.') },

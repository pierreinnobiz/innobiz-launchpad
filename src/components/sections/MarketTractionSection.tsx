...
const MarketTractionSection: React.FC = () => {
  ...
  const proofs = [
    ...
    t3(l, "Revenu par client multiplié par 4 : coffrets saisonniers et routines quotidiennes transforment une vente unique en flux de revenus prévisible et croissant, année après année.", "Per-customer revenue multiplied by 4: seasonal gift sets and daily routines transform a single sale into a predictable, growing revenue stream, year after year.", "Ingresos por cliente multiplicados por 4: estuches estacionales y rutinas diarias transforman una venta única en un flujo de ingresos predecible y creciente, año tras año."),
  ];

...
const WhyInnobizSection: React.FC = () => {
  ...
  const disciplines = [
    ...
    { icon: Cpu, title: t3(language, 'Électronique intelligente', 'Smart electronics', 'Electrónica inteligente'), desc: t3(language, "Contrôle de débit millimétrique, 8h d'autonomie. Plus léger qu'un smartphone.", 'Millimetric flow control, 8-hour autonomy. Lighter than a smartphone.', 'Control de flujo milimétrico, 8h de autonomía. Más ligero que un smartphone.') },
  ];

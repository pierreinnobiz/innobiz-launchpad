...
const WhyInnobizSection: React.FC = () => {
  ...
  const chips = [
    ...
    { icon: Shield, label: t3(language, 'Titulaire de brevet', 'Patent holder', 'Titular de patente'), desc: t3(language, "Twist & Mist est un brevet entièrement détenu et protégé internationalement par Innobiz", 'Twist & Mist is a fully owned, internationally protected Innobiz patent', 'Twist & Mist es una patente totalmente propiedad de Innobiz y protegida internacionalmente') },
